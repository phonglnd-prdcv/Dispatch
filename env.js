...
const BUNDLE_ID = 'com.resgrid.dispatch'; // ios bundle id
const PACKAGE = 'com.resgrid.dispatch'; // android package name
const NAME = 'Resgrid Dispatch'; // app name
const EXPO_ACCOUNT_OWNER = 'resgrid'; // expo account owner
const EAS_PROJECT_ID = 'a46a953a-2a9e-4545-b28d-87e5838db146'; // eas project id
const SCHEME = 'ResgridDispatch'; // app scheme
...
const _clientEnv = {
  ...
  BASE_API_URL: process.env.DISPATCH_BASE_API_URL || 'https://qaapi.resgrid.dev',
  API_VERSION: process.env.DISPATCH_API_VERSION || 'v4',
